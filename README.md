...
# 👋 Hey there, I'm Zaynab — but you can call me **"The BrainWave"** 🧠⚡
 
*Because I literally research brain-computer interfaces AND send waves through every room I walk into.*
...
## 🤖 What I Actually Do *(it's a lot, buckle up)*
 
I'm a **Biomedical & ML Engineer** who decided one career wasn't enough. So I also:
 
- 🦾 Teach robots how to exist *(Robotics Instructor)*
- 🧠 Research how brains talk to computers *(BCI Researcher)*
- 🎓 Teach humans how to think like engineers *(Course Instructor)*
- 🚀 Founded something awesome & transform digital health
- 💡 Consult on Digital Health Transformation
 
Basically, I'm bridging the gap between **human biology and intelligent machines** — one neuron (and one line of code) at a time.
 
---
 
## 🎨 When I'm Not Rewiring Brains or Training Models...
 
You'll catch me:
 
- 📚 Reading everything I can get my hands on *(yes, textbooks and novels)*
- ✏️ Sketching ideas that may or may not turn into inventions
- ✈️ Traveling to new places and immediately wondering how to make them smarter
- 🏋️ Staying fit because a sharp mind needs a strong body
- 🎵 Vibing to music that matches whatever mode I'm in
- 🍳 Cooking meals that are basically just ML experiments with ingredients
...
<img alt="Static Badge" src="https://img.shields.io/badge/Biomedical%20Instrumentation-red">
<img alt="Static Badge" src="https://img.shields.io/badge/Medical%20Device%20Safety-blue">
<img alt="Static Badge" src="https://img.shields.io/badge/Performance%20Evaluation-black">
<img alt="Static Badge" src="https://img.shields.io/badge/Diagnostic%20Systems-pink">
